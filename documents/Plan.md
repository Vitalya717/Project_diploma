...
В БД приложения появляется информация о платежной операции и status "APPROVED"
...
в БД приложения появляется информация о платежной операции и status "DECLINED"
...
Отправить POST запрос платежа с заполненным "body" валидными данными с номером карты 4444 4444 4444 4441 на http://localhost:8080/api/v1/pay 
...
Отправить POST запрос платежа в кредит с заполненным "body" валидными данными с номером карты 4444 4444 4444 4441 на http://localhost:8080/api/v1/credit
*Ожидаемый результат:* статус 200, в БД приложения появляется информация о платежной операции и status "APPROVED".

#### № 12 Отправить запрос на покупку с заблакированной банковской картой и валидными данными

Отправить POST запрос платежа с заполненным "body" валидными данными с номером карты 4444 4444 4444 4442 на http://localhost:8080/api/v1/pay  
...
Отправить POST запрос платежа в кредит с заполненным "body" валидными данными с номером карты 4444 4444 4444 4442 на http://localhost:8080/api/v1/credit  
